...
## CTF flags
- Для каждой группы атак добавлены флаги формата `DIGITAL[...]`.
- Флаги продублированы в БД (`attack_flags`) и также встречаются в ответах/комментариях соответствующих уязвимых маршрутов.
